const languageData = [
  // SRB
  {
    ...
    offer: {
      ...
      points: [
        ...
        {
          img: "images/lock.svg",
          text: "Enkripcija podataka i bezbednost",
        },
        {
          img: "images/hp.svg",
  ...
  {
    nav: [
      { href: "#offer", text: "What we offer?" },
      { href: "#team", text: "Who we are?" },
    ...
    offer: {
      ...
      points: [
        {
          img: "images/brush.svg",
          text: "Website design, development and development",
        },
        {
          img: "images/seo.svg",
  ...
  // GER
  {
    ...
    offer: {
      ...
      points: [
        {
          img: "images/brush.svg",
          text: "Website Design, Entwicklung und Entwicklung",
        },
        {
          img: "images/seo.svg",
        ...
        {
          img: "images/lock.svg",
          text: "Datenverschlüsselung und Sicherheit",
        },
        {
          img: "images/hp.svg",
          text: "24/7 Support",
  ...
  {
    nav: [
      { href: "#offer", text: "Ce que nous vous proposons?" },
      { href: "#team", text: "Qui sommes nous?" },
    ...
    offer: {
      ...
      points: [
        {
          img: "images/brush.svg",
          text: "Conception, développement et développement de sites Web",
        },
        {
          img: "images/seo.svg",
          text: "Optimisation du référencement",
        },
        {
          img: "images/lock.svg",
          text: "Cryptage et sécurité des données",
        },
        {
          img: "images/hp.svg",
